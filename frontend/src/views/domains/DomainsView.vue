            ...
            <tr v-for="domain in filteredDomains" :key="domain.id" class="hover:bg-gray-50 transition-colors duration-150">
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <div class="flex items-center">
                  ...
                  <div class="ml-3">
                    <div class="text-sm font-medium text-gray-900">{{ domain.registrar || 'Not available' }}</div>
            ...
            <div class="space-y-2 text-sm">
              ...
              <div class="flex items-center justify-between pt-2 border-t border-gray-100">
                ...
                <div class="flex items-center space-x-2">
                  ...
                  <div v-if="domain.renewalPrice && domain.renewalPrice > 0" class="flex items-center" title="Renewal price: {{ formatRupiah(domain.renewalPrice) }}">
